...
- **And one button hands you the thing that takes time.** Evolution here moves
  ...
  visibly racing, not frozen — and then a card says what changed while you were
  gone. *42 creatures were alive when you pressed it, and 169 are now. 434 were
  born and 307 died while you were away, 27 of them eaten. 9 more generations
  have been born. The animals here are 23% bigger than the ones you left
  behind. Meat has fallen from 54% of what they eat to 18%.* Underneath, the
  Chronicle's own lines from the stretch you skipped. **⏩ Skip again** goes
  round for another.
...
- **Or don't wait: press ⏩ Skip ahead.** Three seconds of the water running
  fast, and then a card telling you what happened — the crowd, the births and
  the deaths, the generations that went by, how much bigger the animals got and
  what happened to their appetite for meat, with the Chronicle's own lines from
  the stretch underneath. Press **⏩ Skip again** from the card and watch the
  same pond, four presses in, become somewhere you would not recognise.
