...
test("nothing in the simulation reads the books", () => {
  ...
  // of the sixty-one fields wrong for sixty consecutive ticks and check the
  ...
  assert.equal(swept, 61, "the books changed size; the claim above needs re-measuring");
});
